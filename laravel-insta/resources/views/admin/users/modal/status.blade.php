        ...
        <div class="modal-content border-danger">
            <div class="modal-header border-danger">
                <h3 class="modal-title border-danger">
                    <i class="fa-solid fa-user-slash text-danger"></i> Deactivate User
                </h3>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content border-success">
            <div class="modal-header border-success">
                <h3 class="modal-title border-success">
                    <i class="fa-solid fa-user-slash text-success"></i> Deactivate User
                </h3>
            </div>
            <div class="modal-body">
