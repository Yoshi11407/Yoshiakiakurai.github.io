...
@section('content')
    <div class="row gx-5">
        <div class="col-8">
            ...
            @empty
                {{-- If the $all_posts doesn't have any posts yet.--}}
                <div class="text-center">
                    <h2>Share Photos</h2>
                    <p class="text-muted">When you share photos, they'll appear on your profile.</p>
                    <a href="{{route('create')}}" class="text-decoration-none">Share Your First Photo</a>
                </div>
            @endforelse
        </div>
                    ...
                    <div class="row align-items-center mb-3">
                        ...
                        <div class="col-auto">
                            <form action="{{ route('follow.store', $user->id) }}" method="post">
                                @csrf
                                <button type="submit" class="btn border-0 bg-transparent text-primary p-0 btn-sm">Follow</button>
                            </form>
                        </div>
                    </div>
                @endforeach
